...
L.OWM = L.TileLayer.extend({
	options: {
		appId: '28b6782e9e3fed333a392da42eb26f3a', /* pass your own AppId as parameter when creating the layer. Get your own AppId at https://www.openweathermap.org/appid */
...
L.OWM.Current = L.Layer.extend({
	...
	options: {
		...
		imageLoadingUrl: 'pictures/owmloading.gif', // URL of loading image relative to HTML document
