...
<html>
 ...
 <body>
   ...
   <h1><br>How To Grow Cucumber</h1><br>
     <div class="container" id="jumbotext">
      <div class="jumbotron">
	  <img src="pictures/cucumberGrow.jpg" class="img-thumbnail" alt="cucumberGrow" style="width:300px;height:300px;margin-left:15px;">
			<h4> Sowing</h4>
			<p>
