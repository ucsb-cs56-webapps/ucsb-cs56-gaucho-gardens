 ...
 <body>
   ...
   <div style="text-align:left; width:100%; padding:0;">
     ...
     <div class="container" id="jumbotext">
      <div class="jumbotron">
		<h3>ROASTED GARLIC LEMON BROCCOLI</h3>
		<p><img src="pictures/broccolirecipe.jpg" class="img-thumbnail" alt="broccoliRecipe" style="width:300px;height:300px;margin-left:15px;">
		
			<br>
			<br>INGREDIENTS:
			<br>2 heads broccoli, separated into florets
